...
import com.android.internal.util.paranoid.AOSPAHelpers;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public boolean handleKeyEvent(KeyEvent event) {
        ...
        case GESTURE_V_SCANCODE:
            if (AOSPAHelpers.isLightbulbAvailable(mContext)) {
                Intent lgtbulbIntent = new Intent(LightbulbConstants.ACTION_STATE_CHANGED);
                mContext.sendBroadcast(lgtbulbIntent);
            }
            consumed = true;
            break;
